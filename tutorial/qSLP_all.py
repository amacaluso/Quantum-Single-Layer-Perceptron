...
def gate_S(ang, x=None, pad=True):
...
def execute_circuit(parameters, x=None, shots=1000, print=False):
    ...
    param0 = parameters[0]
    param1 = parameters[1:7] #parameters[2:8]
    param2 = parameters[7:13] # parameters[8:14] # params[4:7]
    # param3 = parameters[6:9]
...
def cost(params, X, labels):
    ...
    # pred_labels = [predict(p) for p in predictions]
